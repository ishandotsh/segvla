...
def make_segvla_pre_post_processors(
    config: SegVLAConfig,
    ...
    """
    Constructs pre-processor and post-processor pipelines for the SegVLA policy.
    ...
    Args:
        config: The configuration object for the SegVLA policy.
...
@ProcessorStepRegistry.register(name="segvla_new_line_processor")
class SegVLANewLineProcessor(ComplementaryDataProcessorStep):
    """
